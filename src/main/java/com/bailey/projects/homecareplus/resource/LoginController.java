package com.bailey.projects.homecareplus.resource;
...
public class LoginController {
    ...
    {
        String url = "http://35.194.82.177:4985/homecareplus/_user/";
    ...
    {
        String postUrl = "http://35.194.82.177:4985/homecareplus/_session";
        String deleteUrl = "http://35.194.82.177:4985/homecareplus/_user/" + user.getUsername() + "/_session";
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
        headers.setContentType(MediaType.APPLICATION_JSON);
